...
class OnCallIncidentService(
    ...
    private fun toOnCallIncident(
        ...
        return OnCallIncident(
            ...
            customerImpact = row[OnCallIncidents.customerImpact],
            nextUpdateAt = row[OnCallIncidents.nextUpdateAt]?.toString(),
            updateReminderPaused = row[OnCallIncidents.updateReminderPaused],
            lastUpdateAt = row[OnCallIncidents.lastUpdateAt]?.toString(),
