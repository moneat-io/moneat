...
| `MONEAT_FEATURE_FLAG_ENVIRONMENT` | `production` | Feature-flag environment this deployment evaluates flags against. Optional; set it when other feature-flag rules are configured outside `production`. |
