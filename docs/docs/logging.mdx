...
Logs are stored in ClickHouse for high-performance querying. Retention periods depend on your plan tier. Check your plan details under [Billing & Plans](/billing) for specific retention limits.
