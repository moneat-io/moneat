...
:::tip
Use **Title Case** for event names (e.g., `Add to Cart` not `add_to_cart`). This keeps the dashboard readable and consistent.
:::
...
- Events beyond your plan's quota are dropped with a `429` response
