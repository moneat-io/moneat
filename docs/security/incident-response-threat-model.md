...
| **Integration sim** | Signed Slack interaction across workspace bindings (good/foreign-org/guest/Connect/unmapped/stale); replay same signed body; Twilio signature good/bad and callback replay; outbox duplicate-lease + 429; external audit-outcome failure + quarantine/reconciliation; DLQ + replay; passthrough/native isolation; rollout × entitlement combinations | IDN-01..05, SLK-01..04, OUT-01/02, PASS-01..03, WFL-02, FIL-02, AUD-01 | Feature owners TASK-1.7 through TASK-1.10 / TASK-1.23 / TASK-1.24 / TASK-1.40 / TASK-1.46 / TASK-1.47 / TASK-1.49 / TASK-1.50; harness TASK-1.44; security sign-off TASK-1.48 |
