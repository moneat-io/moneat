...
Replay data is captured by the Sentry SDK's replay integration and sent to Moneat via the standard envelope endpoint. Web replays use rrweb to record DOM mutations. Mobile replays capture video segments.

### Enable in the Sentry SDK
