...
logs_enabled: true
logs_config:
  logs_dd_url: "https://api.moneat.io/dd"
```
...
Logs ingested via the Datadog Agent are stored in ClickHouse alongside logs from other sources. Retention periods depend on your plan tier — check [Billing & Plans](/docs/billing) for details.
