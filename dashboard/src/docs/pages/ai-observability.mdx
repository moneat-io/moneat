...
LLM generation data is stored in ClickHouse with plan-specific retention. Check your plan details under [Billing & Plans](/docs/billing) for specific retention limits.
