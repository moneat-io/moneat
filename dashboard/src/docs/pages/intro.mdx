...
Moneat is a Sentry-compatible observability platform for error monitoring, performance tracing, session replay, logging, uptime tracking, and incident management. Use any existing Sentry SDK to get started.
...
- [Error Monitoring](/docs/error-monitoring) - Capture and track errors using Sentry-compatible SDKs
