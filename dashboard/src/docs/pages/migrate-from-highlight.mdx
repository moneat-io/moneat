...
Moneat is Sentry-protocol compatible, which means migrating from highlight.io is straightforward: swap the SDK and point your DSN at Moneat. This guide provides a copy-paste AI prompt you can use to automate the migration across your codebase.
...
| `H.track(event, metadata)` | N/A No direct equivalent - see TODO note above |
...
| `H.recordMetric/Count/Histogram()` | N/A No equivalent |
