...
Link uptime monitors to status page components. When a monitor detects downtime, the component status is automatically updated — no manual intervention needed.
:::
...
:::info[Status pages are accessible at `moneat.io/s/your-slug`. The page is designed to be clean and professional, matching your organization's brand.]
:::
