...
describe('use-toast reducer', () => {
  ...
  describe('ADD_TOAST', () => {
    ...
    it('prepends new toast', () => {
      ...
      const toast = { id: '2', title: 'Second', open: true } as any
  ...
  describe('UPDATE_TOAST', () => {
    ...
    it('does not modify non-matching toasts', () => {
      const state = { toasts: [{ id: '1', title: 'Keep', open: true } as any] }
  ...
  describe('REMOVE_TOAST', () => {
    it('removes specific toast', () => {
      const state = { toasts: [{ id: '1', title: 'Remove Me', open: true } as any] }
