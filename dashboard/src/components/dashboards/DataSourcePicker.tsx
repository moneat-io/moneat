...
import {DATA_SOURCE_TYPES} from './DataSourceTypePicker'
...
const BUILTIN_ICONS: Record<string, React.ReactNode> = {
  ...
  system_metrics: <Cpu className="h-4 w-4 text-green-500" />,
  container_metrics: <Box className="h-4 w-4 text-orange-500" />,
