...
const DiscordLogo = ({className}: {className?: string}) => (
  <svg aria-labelledby="discord-logo-title" viewBox="0 0 24 24" fill="#5865F2" className={className} xmlns="http://www.w3.org/2000/svg">
    <title id="discord-logo-title">Discord</title>
