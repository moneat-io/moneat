...
export function BlogPostFeedback({slug}: {slug: string}) {
  ...
  return (
    <div className="mt-12 border-t border-slate-200 pt-8">
      <p className="mb-3 text-center text-sm text-slate-500">Was this article helpful?</p>
      ...
      {state === 'thumbs-down' && (
        <div className="mx-auto max-w-md">
          <Label htmlFor="blog-feedback-comment" className="sr-only">
            What could be improved?
          </Label>
          <Textarea
            id="blog-feedback-comment"
            value={comment}
