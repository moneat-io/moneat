...
// Common IANA timezone identifiers with readable labels
export const TIMEZONES = [
  ...
  { value: 'America/Halifax', label: 'America/Halifax (Atlantic Canada)' },
  { value: 'America/Winnipeg', label: 'America/Winnipeg (Central Canada)' },
  { value: 'America/Edmonton', label: 'America/Edmonton (Mountain Canada)' },
  ...
  { value: 'Africa/Nairobi', label: 'Africa/Nairobi (East Africa)' },
]
