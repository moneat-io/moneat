...
package com.moneat.enterprise.analytics.routes

import com.moneat.config.RedisConfig
import com.moneat.enterprise.analytics.models.AnalyticsEventPayload
...
import com.moneat.enterprise.analytics.services.GeoIpService
import com.moneat.enterprise.analytics.services.ReferrerParser
import com.moneat.enterprise.analytics.services.SessionHashService
import com.moneat.enterprise.analytics.services.UserAgentService
...
fun Route.analyticsIngestRoutes(
    ...
    route("/api/{projectId}/analytics") {
        post("/event") {
            ...
            // Auth via sentry_key query param or X-Sentry-Auth header (same DSN auth as error ingestion)
            ...
            // Extract client info — these are used for hashing/enrichment only, never stored
            ...
            // Update real-time HyperLogLog counter (5-minute window)
