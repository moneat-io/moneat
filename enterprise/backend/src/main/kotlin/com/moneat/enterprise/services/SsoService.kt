...
package com.moneat.enterprise.services

import com.auth0.jwt.JWT
import com.auth0.jwt.algorithms.Algorithm
import com.moneat.enterprise.models.SsoCallbackData
import com.moneat.enterprise.models.SsoConfigRequest
import com.moneat.enterprise.models.SsoConfigResponse
import com.moneat.enterprise.models.SsoInitResponse
import com.moneat.enterprise.models.SsoProviderType
import com.moneat.models.Memberships
import com.moneat.models.Organizations
import com.moneat.models.SsoConfigurations
import com.moneat.models.UserSsoLinks
...
class SsoService {
    ...
    private fun generateSamlRequest(
        ...
        return "$idpSsoUrl${separator}SAMLRequest=${java.net.URLEncoder.encode(
            samlRequest,
            "UTF-8",
        )}&RelayState=${java.net.URLEncoder.encode(state, "UTF-8")}"
    }
