...
class AiFeatureRegistryTest {
    ...
    @Test
    fun `ServiceLoader discovers AI module from feature resources`() {
        val moduleNames = ServiceLoader.load(EnterpriseModule::class.java)
            .map { module -> module.name }

        assertTrue("AI" in moduleNames)
    }

    @Test
    fun `features response includes AI when runtime module is present`() = testApplication {
        application {
        ...
        assertTrue("AI" in response.modules)
    }
