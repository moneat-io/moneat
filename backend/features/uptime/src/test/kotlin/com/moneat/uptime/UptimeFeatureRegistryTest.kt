...
class UptimeFeatureRegistryTest {
    ...
    @Test
    fun `ServiceLoader discovers Uptime module from feature resources`() {
    ...
    @Test
    fun `features response includes Uptime when runtime module is present`() = testApplication {
        application {
        ...
        assertTrue("Uptime" in response.modules)
    }
