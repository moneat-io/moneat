...
class LogsFeatureRegistryTest {
    ...
    @Test
    fun `ServiceLoader discovers Logs module from feature resources`() {
    ...
    @Test
    fun `features response includes Logs when runtime module is present`() = testApplication {
        application {
        ...
        assertTrue("Logs" in response.modules)
    }
