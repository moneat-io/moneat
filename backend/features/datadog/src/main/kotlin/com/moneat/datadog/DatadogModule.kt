...
import com.moneat.datadog.security.datadogSbomRoutes
...
import com.moneat.enterprise.IngestionRateLimitKeyResolver
...
class DatadogModule : EnterpriseModule, IngestionRateLimitKeyResolver {
    ...
    override val rateLimitName: String = "datadog-ingestion"

    override fun resolveRateLimitKey(call: ApplicationCall): String? {
        val apiKey = DatadogAuthMiddleware.extractApiKey(call) ?: return null
        return DatadogAuthMiddleware.resolveOrgId(apiKey)?.let { "org:$it" }
    }
