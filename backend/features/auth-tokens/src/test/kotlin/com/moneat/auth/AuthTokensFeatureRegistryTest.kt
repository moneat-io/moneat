...
class AuthTokensFeatureRegistryTest {
    ...
    @Test
    fun `ServiceLoader discovers Auth Tokens module from feature resources`() {
    ...
    @Test
    fun `features response includes Auth Tokens when runtime module is present`() = testApplication {
        application {
        ...
        assertTrue("Auth Tokens" in response.modules)
    }
