...
class PublicSerializableResourceIdsTest {
    ...
    private fun sourceRoots(): List<SourceRoot> {
        ...
        return listOf(
            ...
            SourceRoot("backend", repoRoot.resolve("backend/features/account-deletion/src/main/kotlin")),
            ...
            SourceRoot("backend", repoRoot.resolve("backend/features/synthetics/src/main/kotlin")),
    ...
    private companion object {
        ...
        private val allowedInternalIdentifiers =
            buildSet {
                ...
                addAll(
                    allow(
                        "backend:com/moneat/security/ingestion/SecurityIngestionService.kt",
                        "QueuedSecurityBatch",
                        "organizationId"
                    )
                )
