...
object SlackInstallations : Table("slack_installations") {
    ...
    val botUserId = varchar("bot_user_id", 100).nullable()
    val accessTokenCiphertext = text("access_token_ciphertext").nullable()
    val accessTokenKeyId = varchar("access_token_key_id", 100).nullable()
