...
class EnterpriseAiChatService(
    ...
    suspend fun searchAndPrepareContext(
        ...
        sendSse(writer, json.encodeToString(SseSearchProgress.serializer(),
        ...
        sendSse(writer, json.encodeToString(SseContextReady.serializer(),
            SseContextReady(
        ...
        confirmAndGenerate(writer, userId, orgId, snapshotId)
    ...
    suspend fun confirmAndGenerate(
        ...
        if (context == null) {
            sendSse(writer, json.encodeToString(SseError.serializer(),
        ...
        try {
            val llmResponse = SentryUtils.withTransactionData("Moneat AI Chat", "ai.run") { setData ->
                ...
                val response = llmProvider.chatCompletion(messages, LlmConfig(
                    maxTokens = 4096,
                    temperature = 0.3,
                    jsonMode = false,
                ))
            ...
            sendSse(writer, json.encodeToString(SseResponseChunk.serializer(),
