...
class LogQueryParserIntegrationTest {
    ...
    private fun chBaseUrl(): String =
        "http://${clickhouse.host}:${clickhouse.getMappedPort(8123)}"
    ...
    private suspend fun executeRawQuery(sql: String): String {
        val resp = httpClient.post(chBaseUrl()) {
    ...
    private suspend fun insertSeedData() {
        ...
        val insertSql = "INSERT INTO logs ($cols) VALUES " +
    ...
    private suspend fun queryLogIds(ddQuery: String): List<String> {
        ...
        val whereCondition = if (parsed.rootNode != null) {
    ...
    @Test
    @Order(1)
    fun `simple term search matches logs containing the term`() = runBlocking {
    ...
    @Test
    @Order(2)
    fun `quoted phrase search matches exact phrase only`() = runBlocking {
    ...
    @Test
    @Order(3)
    fun `full-text search with asterisk prefix searches all attributes`() = runBlocking {
    ...
    @Test
    @Order(11)
    fun `OR widens results`() = runBlocking {
    ...
    @Test
    @Order(12)
    fun `NOT excludes results`() = runBlocking {
    ...
    @Test
    @Order(13)
    fun `implicit AND with consecutive terms`() = runBlocking {
    ...
    @Test
    @Order(20)
    fun `attribute search with @ prefix matches tags`() = runBlocking {
    ...
    @Test
    @Order(21)
    fun `reserved attribute service without @ prefix`() = runBlocking {
    ...
    @Test
    @Order(22)
    fun `status maps to level column`() = runBlocking {
    ...
    @Test
    @Order(23)
    fun `host reserved attribute`() = runBlocking {
    ...
    @Test
    @Order(24)
    fun `source reserved attribute`() = runBlocking {
    ...
    @Test
    @Order(25)
    fun `environment reserved attribute`() = runBlocking {
    ...
    @Test
    @Order(26)
    fun `attribute search matches resource_attributes`() = runBlocking {
    ...
    @Test
    @Order(30)
    fun `wildcard prefix match on service`() = runBlocking {
    ...
    @Test
    @Order(31)
    fun `wildcard single character match`() = runBlocking {
    ...
    @Test
    @Order(32)
    fun `wildcard suffix match`() = runBlocking {
    ...
    @Test
    @Order(33)
    fun `full-text wildcard search`() = runBlocking {
    ...
    @Test
    @Order(34)
    fun `wildcards inside quotes treated as literals`() = runBlocking {
    ...
    @Test
    @Order(40)
    fun `range query on tag value`() = runBlocking {
    ...
    @Test
    @Order(41)
    fun `greater than operator`() = runBlocking {
    ...
    @Test
    @Order(42)
    fun `greater than or equal operator`() = runBlocking {
    ...
    @Test
    @Order(43)
    fun `less than operator`() = runBlocking {
    ...
    @Test
    @Order(44)
    fun `less than or equal operator`() = runBlocking {
    ...
    @Test
    @Order(50)
    fun `existence check for tag returns logs that have the attribute`() = runBlocking {
    ...
    @Test
    @Order(51)
    fun `non-existence check returns logs without the attribute`() = runBlocking {
    ...
    @Test
    @Order(52)
    fun `existence check for top-level field`() = runBlocking {
    ...
    @Test
    @Order(60)
    fun `tags colon checks tag key existence`() = runBlocking {
    ...
    @Test
    @Order(61)
    fun `grouped field values with OR`() = runBlocking {
    ...
    @Test
    @Order(62)
    fun `grouped field values on top-level field`() = runBlocking {
    ...
    @Test
    @Order(70)
    fun `escaped colon in attribute value`() = runBlocking {
    ...
    @Test
    @Order(71)
    fun `quoted value with special characters`() = runBlocking {
    ...
    @Test
    @Order(72)
    fun `SQL injection attempt is safely escaped`() = runBlocking {
    ...
    @Test
    @Order(73)
    fun `query with backslash in value`() = runBlocking {
    ...
    @Test
    @Order(80)
    fun `empty query returns all logs`() = runBlocking {
        val ids = queryLogIds("")
    ...
    @Test
    @Order(81)
    fun `whitespace-only query returns all logs`() = runBlocking {
        val ids = queryLogIds("   ")
    ...
    @Test
    @Order(82)
    fun `unclosed quote handles gracefully`() = runBlocking {
    ...
    @Test
    @Order(84)
    fun `deeply nested parentheses`() = runBlocking {
    ...
    @Test
    @Order(85)
    fun `very long query string`() = runBlocking {
    ...
    @Test
    @Order(86)
    fun `unicode in search terms`() = runBlocking {
        // Should not throw
    ...
    @Test
    @Order(90)
    fun `level field with toString cast works against real Enum8`() = runBlocking {
    ...
    @Test
    @Order(91)
    fun `source field with toString cast works against real Enum8`() = runBlocking {
    ...
    @Test
    @Order(92)
    fun `wildcard on enum field works`() = runBlocking {
    ...
    @Test
    @Order(93)
    fun `status synonym maps to level and works with Enum8`() = runBlocking {
    ...
    @Test
    @Order(100)
    fun `real-world query - error in production api`() = runBlocking {
    ...
    @Test
    @Order(101)
    fun `real-world query - slow responses`() = runBlocking {
    ...
    @Test
    @Order(102)
    fun `real-world query - auth failures excluding test users`() = runBlocking {
    ...
    @Test
    @Order(103)
    fun `real-world query - non-200 status codes in production`() = runBlocking {
